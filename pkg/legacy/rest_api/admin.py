...
async def add_audit_log(action_type, mod_username, mod_ip, data):
...
async def get_users(query_args: GetUsersQueryArgs):
    ...
    # Add log
    await add_audit_log("got_users", request.user, request.ip, {"page": query_args.page})
...
async def get_chat(chat_id):
    ...
    # Add log
    await add_audit_log("got_chat", request.user, request.ip, {"chat_id": chat_id})
...
async def update_chat(chat_id, data: UpdateChatBody):
    ...
    await add_audit_log("updated_chat", request.user, request.ip, updated_vals)
...
async def delete_chat(chat_id):
    ...
    # Add log
    await add_audit_log("deleted_chat", request.user, request.ip, {"chat_id": chat_id})
...
async def restore_chat(chat_id):
    ...
    # Add log
    await add_audit_log("restored_chat", request.user, request.ip, {"chat_id": chat_id})
...
async def transfer_chat_ownership(chat_id, username):
    ...
    # Add log
    await add_audit_log("transferred_chat_ownership", request.user, request.ip, {"chat_id": chat_id, "username": username})
...
async def get_netinfo(ip):
    ...
    # Add log
    await add_audit_log("got_netinfo", request.user, request.ip, {"ip": ip})
...
async def get_netblocks(query_args: GetNetblocksQueryArgs):
    ...
    # Add log
    await add_audit_log("got_netblocks", request.user, request.ip, {"page": query_args.page})
...
async def kick_all_clients():
    ...
    # Add log
    await add_audit_log("kicked_all", request.user, request.ip, {})
...
async def enable_repair_mode():
    ...
    # Add log
    await add_audit_log("enabled_repair_mode", request.user, request.ip, {})
...
async def disable_registration():
    ...
    # Add log
    await add_audit_log("disabled_registration", request.user, request.ip, {})
...
async def enable_registration():
    ...
    # Add log
    await add_audit_log("enabled_registration", request.user, request.ip, {})
